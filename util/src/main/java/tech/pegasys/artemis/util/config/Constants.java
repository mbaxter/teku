...
public class Constants {
  ...
  // Misc
  public static Bytes4 GENESIS_FORK = new Bytes4(Bytes.of(0, 0, 0, 0));
  ...
  public static void setConstants(String networkName) {
  ...
  private static void setSaphireConstants() {
    GENESIS_FORK = new Bytes4(Bytes.of(0, 0, 0, 4));
    FAR_FUTURE_EPOCH = UnsignedLong.valueOf(new BigInteger("18446744073709551615", 10));
    ...
    MIN_GENESIS_TIME = UnsignedLong.ZERO;
    MIN_DEPOSIT_AMOUNT = 100000000;
    MAX_EFFECTIVE_BALANCE = 3200000000L;
    EJECTION_BALANCE = 1600000000;
    EFFECTIVE_BALANCE_INCREMENT = 100000000;
    GENESIS_SLOT = 0;
    BLS_WITHDRAWAL_PREFIX = Bytes.fromHexString("0x00");
    SECONDS_PER_SLOT = 12;
    ...
    INACTIVITY_PENALTY_QUOTIENT = 3355443;
    MIN_SLASHING_PENALTY_QUOTIENT = 32;
    SAFE_SLOTS_TO_UPDATE_JUSTIFIED = 8;
    DOMAIN_BEACON_PROPOSER = new Bytes4(Bytes.fromHexString("0x00000000"));
    DOMAIN_BEACON_ATTESTER = new Bytes4(Bytes.fromHexString("0x01000000"));
    DOMAIN_RANDAO = new Bytes4(Bytes.fromHexString("0x02000000"));
    DOMAIN_DEPOSIT = new Bytes4(Bytes.fromHexString("0x03000000"));
    DOMAIN_VOLUNTARY_EXIT = new Bytes4(Bytes.fromHexString("0x04000000"));
    ...
    ETH1_FOLLOW_DISTANCE = UnsignedLong.valueOf(1024);
  }

  private static void setMainnetConstants() {
    // Misc
    GENESIS_FORK = new Bytes4(Bytes.of(0, 0, 0, 0));
    MAX_COMMITTEES_PER_SLOT = 64;
    TARGET_COMMITTEE_SIZE = 128;
    MAX_VALIDATORS_PER_COMMITTEE = 2048;
    MIN_PER_EPOCH_CHURN_LIMIT = 4;
    ...
    // Gwei values
    MIN_DEPOSIT_AMOUNT = 1_000_000_000L;
  ...
  private static void setMinimalConstants() {
    // Misc
